...
<div class="container">
  ...
  <div class="row">
    <div class="col">
      <div class="btn btn-primary"><a href="/products/create">Agregar Nuevo Producto</a></div>
    </div>
            ...
            <div class="col-sm-4">
                ...
                @endif
                  ...
                  <form class="quantity" action="/carrito" method="post" enctype="multipart/form-data">
                    @csrf
                    <input class="input-quantity" type="number" name="quantity" min="1" max="5" value="1">
